...
/** @brief Host FAL flash device name. */
#define QBOOT_HOST_FAL_FLASH_NAME "host-flash"
/** @brief APP partition offset in host FAL flash. */
#define QBOOT_HOST_FAL_APP_OFFSET      0u
/** @brief DOWNLOAD partition offset in host FAL flash. */
#define QBOOT_HOST_FAL_DOWNLOAD_OFFSET \
    (QBOOT_HOST_FAL_APP_OFFSET + QBOOT_HOST_APP_LEN)
/** @brief FACTORY partition offset in host FAL flash. */
#define QBOOT_HOST_FAL_FACTORY_OFFSET \
    (QBOOT_HOST_FAL_DOWNLOAD_OFFSET + QBOOT_HOST_DOWNLOAD_LEN)
...
static struct fal_partition g_fal_parts[] = {
    { "app", QBOOT_HOST_FAL_FLASH_NAME, QBOOT_HOST_FAL_APP_OFFSET,
      QBOOT_HOST_APP_LEN },
    { "download", QBOOT_HOST_FAL_FLASH_NAME, QBOOT_HOST_FAL_DOWNLOAD_OFFSET,
      QBOOT_HOST_DOWNLOAD_LEN },
    { "factory", QBOOT_HOST_FAL_FLASH_NAME, QBOOT_HOST_FAL_FACTORY_OFFSET,
      QBOOT_HOST_FACTORY_LEN },
};
