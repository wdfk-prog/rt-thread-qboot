...
#if !defined(QBOOT_HOST_DISABLE_PRODUCT_CODE)
#define QBOOT_USING_PRODUCT_CODE
#define QBOOT_PRODUCT_CODE "host-product"
#endif /* !defined(QBOOT_HOST_DISABLE_PRODUCT_CODE) */
...
#ifndef QBOOT_HPATCH_COPY_BUFFER_SIZE
#define QBOOT_HPATCH_COPY_BUFFER_SIZE      4096
#endif /* QBOOT_HPATCH_COPY_BUFFER_SIZE */
#else
...
#if defined(QBOOT_HOST_DISABLE_APP_CHECK)
#define QBOOT_DISABLE_APP_CHECK
#endif /* defined(QBOOT_HOST_DISABLE_APP_CHECK) */
#define QBOOT_USING_UPDATE_MGR
#define QBOOT_UPDATE_MGR_USE_DOWNLOAD_HELPER

#ifndef QBOOT_HPATCH_RAM_BUFFER_SIZE
#define QBOOT_HPATCH_RAM_BUFFER_SIZE       4096
#endif /* QBOOT_HPATCH_RAM_BUFFER_SIZE */
#ifndef QBOOT_HPATCH_PATCH_CACHE_SIZE
#define QBOOT_HPATCH_PATCH_CACHE_SIZE      1024
#endif /* QBOOT_HPATCH_PATCH_CACHE_SIZE */
#ifndef QBOOT_HPATCH_DECOMPRESS_CACHE_SIZE
#define QBOOT_HPATCH_DECOMPRESS_CACHE_SIZE 1024
#endif /* QBOOT_HPATCH_DECOMPRESS_CACHE_SIZE */
