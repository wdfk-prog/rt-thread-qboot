 ...
 *                   offset-gap, out-of-order, offset-overlap,
 *                   same-offset-different-data, or protocol-* negative tests.
 *                   Strict protocol modes exercise a host adapter simulation
 *                   before the qboot helper accepts a complete transfer.
