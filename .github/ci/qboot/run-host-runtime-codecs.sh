...
find_header_dir() {
  ...
  file_path=$(find_header_path "$package" "$header")
  dirname "$file_path"
}
...
crc_adapter_header=$(find_header_path crclib crc32.h)
tiny_adapter_header=$(find_header_path tinycrypt tinycrypt.h)

hpatch_header_dir=$(find_header_dir hpatchlite hpatch_impl.h)
hpatch_header_dirs=$(find_header_dirs hpatchlite)
...
$(find_header_dir crclib crc32.h)
$(find_header_dir tinycrypt tinycrypt.h)
$(find_header_dir zlib zlib.h)
$(find_header_dir quicklz quicklz.h)
$(find_header_dir fastlz fastlz.h)
$hpatch_header_dirs
EOF_INCLUDE_DIRS
...
crc_source=$(select_required_source crclib crc32_cal)
crc_cyc_source=$(select_required_source crclib crc32_cyc_cal)
...
tiny_source=$(select_required_source tinycrypt tiny_aes_setkey_dec)
tiny_cbc_source=$(select_required_source tinycrypt tiny_aes_crypt_cbc)
...
append_optional_sources "$(find_zlib_sources)"
append_source_path "$(select_required_source quicklz qlz_decompress)"
append_source_path "$(select_required_source fastlz fastlz_decompress)"
hpatch_source=$(select_required_source hpatchlite hpi_patch)
hpatch_lite_source=$(select_hpatch_lite_core_source)
hpatch_tuz_source=$(select_hpatch_tuz_source)
