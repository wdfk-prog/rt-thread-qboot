...
# to upload.
rm -rf _ci/rt-thread-base _ci/profile-builds _ci/env
...
stage_git_package crclib https://github.com/qiyongzhong0/crclib.git "${CRCLIB_REF:-master}"
prune_crclib_sample_sources
stage_git_package tinycrypt https://github.com/RT-Thread-packages/tinycrypt.git "${TINYCRYPT_REF:-master}"
stage_git_package zlib https://github.com/RT-Thread-packages/zlib.git "${ZLIB_REF:-master}"
isolate_zlib_private_crc32_header
stage_git_package quicklz https://github.com/RT-Thread-packages/quicklz.git "${QUICKLZ_REF:-master}"
stage_git_package fastlz https://github.com/RT-Thread-packages/fastlz.git "${FASTLZ_REF:-master}"
stage_git_package qled https://github.com/qiyongzhong0/rt-thread-qled.git "${QLED_REF:-master}"
stage_git_package hpatchlite https://github.com/wdfk-prog/hpatchlite-wrapper.git "${HPATCHLITE_REF:-master}"
