...
网页工具：[QBoot RBL Packager](https://wdfk-prog.space/rt-thread-qboot/package-tool/index.html)
...
- [QBoot RBL Packager 网页工具](https://wdfk-prog.space/rt-thread-qboot/package-tool/index.html)
...
4. 使用 [QBoot RBL Packager 网页工具](https://wdfk-prog.space/rt-thread-qboot/package-tool/index.html) 或 `tools/package_tool.py` 生成 `.rbl` 文件
5. 需要升级接收状态机时再看 [升级接收流程框架](docs/zh/update-manager.md)
6. 需要差分升级时再看 [HPatchLite 差分升级](docs/zh/differential-ota-hpatchlite.md)
